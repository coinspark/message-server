<?php
    ...
    function init_errors()
    {
        return array(
            ...
            array("t"=>"-","n"=>"sender ip blocked permanently"   ,"r"=>"pre_create"  ,"c"=>COINSPARK_ERR_SENDER_IP_NOT_ACCEPTED       ,"v"=>COINSPARK_CREATE_IP_BLOCKED),
            array("t"=>"-","n"=>"sender ip not allowed"           ,"r"=>"pre_create"  ,"c"=>COINSPARK_ERR_SENDER_IP_NOT_ACCEPTED       ,"v"=>COINSPARK_CREATE_IP_OTHER_ALLOWED),
            array("t"=>"-","n"=>"sender ip max usage"             ,"r"=>"pre_create"  ,"c"=>COINSPARK_ERR_SENDER_IP_IS_SUSPENDED       ,"v"=>COINSPARK_CREATE_IP_OTHER_DAILY_MAX),
            array("t"=>"-","n"=>"sender ip blocked temporarily"   ,"r"=>"pre_create"  ,"c"=>COINSPARK_ERR_SENDER_IP_IS_SUSPENDED       ,"v"=>"DB"),
            ...
            array("t"=>"-","n"=>"recipient ip blocked permanently","r"=>"pre_retrieve","c"=>COINSPARK_ERR_RECIPIENT_IP_NOT_ACCEPTED    ,"v"=>COINSPARK_RETRIEVE_IP_BLOCKED),
            array("t"=>"-","n"=>"recipient ip not allowed"        ,"r"=>"pre_retrieve","c"=>COINSPARK_ERR_RECIPIENT_IP_NOT_ACCEPTED    ,"v"=>COINSPARK_RETRIEVE_IP_OTHER_ALLOWED),
            array("t"=>"-","n"=>"recipient ip max usage"          ,"r"=>"pre_retrieve","c"=>COINSPARK_ERR_RECIPIENT_IP_IS_SUSPENDED    ,"v"=>COINSPARK_RETRIEVE_IP_OTHER_DAILY_MAX),
            array("t"=>"-","n"=>"recipient ip blocked temporarily","r"=>"pre_retrieve","c"=>COINSPARK_ERR_RECIPIENT_IP_IS_SUSPENDED    ,"v"=>"DB"),
